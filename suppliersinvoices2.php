        ...
        if (confirmdelete && accessname != null && accesspass != null) {
            $.ajax({
                ...
                success: function(response) {
                    $("#patientinvoices").load("suppliersinvoices2.php #patientinvoicestable", function() {
...
<div id="patientinvoicestable">
	<h3  style="text-align:center;font-weight:bold;text-decoration:underline;" >INVOICES TRACKING REPORT<br><?php 
...
<table class="table"    style="text-align:center;font-size:90%;margin-right:2%;margin-left:2%;">
 ...
 <td  class="theader"    height="21" valign="top" >DATE	  </td>
  ...
  <td  class="theader"    height="21" valign="top" >TR REFF	  </td>
			...
			<td  class="theader"    height="21" valign="top" >VIEW INVOICE	  </td>
...
<a   href="viewsuppliersinvoice.php?invoicenumber=<?php  print $data->TRANSACTIONREFF; ?>"><i class="fas fa-file-invoice" style="font-size:160%;"></i></a>
