...
$connect ->query("DELETE  FROM supplierpayment  WHERE SUPPLIER=(SELECT COMPANY FROM cashflow  WHERE ID='$deletesupplierpay->deleteid')   AND PAYREFFERENCE=(SELECT TRANSACTIONREFF FROM cashflow  WHERE ID='$deletesupplierpay->deleteid') ");
