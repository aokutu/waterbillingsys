...
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#reports").load("disconnectionreport.php #accbaldata");$('#message').modal('show');
...
function(data){
$("#content").load("message.php #content");$("#reports").load("disconnectionreport.php #accbaldata"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
