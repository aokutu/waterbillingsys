...
body{font-size:small;} body {text-transform:inherit;}
...
$("#registry").modal();
$("#sendcustormsms").load("custormsmstable.php #accountstable");
$('[data-toggle="popover"]').popover(); 
$("#registry").submit(function(){$('#prepostmessage').modal('show');
$.post( "searchregistry.php",
$("#registry").serialize(),
function(data){
$("#content").load("message.php #content");$("#sendcustormsms").load("custormsmstable.php #accountstable"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
$("#sendcustormsms").submit(function(){$('#prepostmessage').modal('show');
$.post( "sendcustormsms.php",
$("#sendcustormsms").serialize(),
function(data){
$("#content").load("message.php #content");$("#sendcustormsms").load("custormsmstable.php #accountstable"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
<option value="nonrespondant">NON RESPONDANT METER</option>
...
<input name='' type='checkbox' id="checkall" class='form-control input-sm'></div>
 ...
 <form id="sendcustormsms"   method="post" action="sendcustormsms.php"  >
 </form>
