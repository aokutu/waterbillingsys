...
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#trail").load("audittrail.php #trailtable");  $('#message').modal('show'); 
...
<div  id="trailtable"  method="post" > 
<h4   style="text-align:center"><strong>AUDIT TRAIL REPORT FROM  <?php print $_SESSION['date1'];?> TO  <?php print $_SESSION['date2'];?>  </strong></h4>
 ...
 <table    class=" table table-hover">
       ...
       <?php
		$date1=$_SESSION['date1'];$date2=$_SESSION['date2'];
		//SELECT DATE_ADD(my_date, INTERVAL 3 HOUR) AS new_date FROM my_table;
	$x=$connect->query("SELECT *,DATE_ADD(session, INTERVAL 3 HOUR) AS sessionx FROM events WHERE DATE >='$date1'  AND  DATE <='$date2' ORDER  BY  session DESC  ");
