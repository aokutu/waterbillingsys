...
#idnumber-list li:hover{background:#F0F0F0;}
#search-box{padding: 10px;border: #F0F0F0 1px solid;} 
#header{ background-color: #80DCF0; height:400px; }.dropdown-menu{ overflow-y: scroll; height: 300%;       
   position: absolute;
}
...
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#reports").load("revenuereport3.php #accbaldata");$('#message').modal('show');
...
function(data){
$("#content").load("message.php #content");$("#reports").load("revenuereport3.php #accbaldata"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="VIEW REPORTS" data-placement="bottom"><button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#viewreports">VIEW REPORTS</button></a>
  ...
  <div class="modal-content"><div class="modal-header"><div class="modal-header">SELECT 1 ST MONTH  
  <div class="container">
  <div class="row">
  <div class="col-sm-8">  <br>
DATE
<input   name="month" type="month" size="15"   required="on"  class="form-control input-sm"    autocomplete="off" ><br>
<select class="form-control" name="range" required="on">
 <option value="">SELECT REPORT RANGE</option>
 <option value="2">1ST QUOTER</option>
 <option value="5">2ND QUOTER</option>
 <option value="8">3RD QUOTER</option>
 <option value="11">4TH  QUOTER</option>
	 <option value=""></option>		   
 </select><br>
	  ...
	  <li><a href="graphsummary.php"  target= "_blank">GRAPH SUMMARY</a></li> 
        <li><a href="accountstatus.php">ACC CURRENT STATUS </a></li><li><a href="watersalereport.php">WATER SALE REPORT </a></li> 
		 ...
		 <li><a href="ministatement.php">MINISTATEMENT</a></li> 
		   <li><a href="statements.php">FULL STATEMENT</a></li><li><a href="refunddeposit.php">REFUND DEPOSIT</a></li><li><a href="archivedstatements.php">ARCHIVED STATEMENT</a></li><li><a href="archivedstatements.php">ARCHIVED STATEMENT</a></li><li><a href="archivedstatements.php"> STATEMENT</a></li><li><a href="bills2report.php">BILLS DISTRIBUTION  REPORT</a></li><li><a href="revenue.php">REVENUE  DISTRIBUTION  REPORT</a></li>
		   <li><a href="balancereport.php">ACC  BAL DISTRIBUTION REPORT </a></li><li><a href="analysisreport.php">MONTHLY DATA ANALYSIS </a></li><li><a href="banking.php">BANKING  REPORT</a></li><li><a href="archivebanking.php">ARCHIVED BANKING  REPORT</a></li>
