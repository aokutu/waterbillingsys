...
<body>
  <div class="container">
  <div class="row">
  <div class="col-sm-6">  <button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#searchslipcode">SEARCH NOTIFICATIONS</button> 
...
<?php  include_once("dashboard3.php");  include_once("dashboard3.php");  include_once("chat.php");?>
<!-- 	dashboard-->
...
<div class="container">
  <div class="row">
   ...
   <div class="col-sm-8">SELECT  NOTIFICATIONS  PROCESSING DATE<br>
    <input type="date" class="form-control input-sm" required    name="date1"     /><br>
	<input type="date" class="form-control input-sm" required     name="date2"     /><br>
