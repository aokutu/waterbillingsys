...
$("#bills").load("billpaymentreport2.php #accbaldata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("sessionregistry.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$("#bills").load("billpaymentreport2.php #accbaldata");$('#prepostmessage').modal('hide'); $('#message').modal('show');
...
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="VIEW REPORTS" data-placement="bottom"><button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#viewreports">VIEW REPORTS</button></a>
  ...
  <form class="modal fade" id="viewreports" role="dialog"    action="billpaymentreport2.php" method="post"  >
...
FROM 
<input   name="date1" type="date" size="15"   required="on"  class="form-control input-sm"    autocomplete="off" ><br>
