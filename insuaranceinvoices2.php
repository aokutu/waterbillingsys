...
$cashflow->insuarance=$connect->real_escape_string(trim(addslashes(strtoupper($_SESSION['insuarance']))));
...
<div id="patientinvoicestable">
	...
	print $cashflow->insuarance;  ?><br>FROM <?php print $cashflow->date1; ?> TO <?php print $cashflow->date2; ?></h3>
...
$connect->query(" INSERT INTO  cashflow(COMPANY,TRANSACTION,TRANSACTIONREFF,AMOUNT,DATE) SELECT INSUARANCE,CONCAT('INVOICE'),INVOICENUMBER,SUM(AMOUNT),DATE FROM invoicerecords WHERE INSUARANCE='$cashflow->insuarance' AND DATE >='$cashflow->date1' AND DATE <='$cashflow->date2'  " );
