...
*/
$connect ->query("DELETE FROM bloodtransfusionobservation WHERE  transfusionid=(SELECT TRACKKEY FROM bloodtransfusion WHERE  ID ='$deletebloodsugarrecord->deleteid' ) ");
$connect ->query("DELETE FROM bloodtransfusion WHERE  ID ='$deletebloodsugarrecord->deleteid'  ");
