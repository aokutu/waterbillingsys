...
<div class="container"  id="menu">
  ...
  <button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#smsreport">AGING ANALYSIS REPORT</button>


  
    <!-- Modal -->
  </div>
 <form class="modal fade" id="smsreport" role="dialog" method="post"  action="agingreport2.php">
  <div class="modal-dialog modal-lg"  >
  <div class="modal-content"><div class="modal-header"><div class="modal-header">AGING ANALYSIS YEAR</div></div>
<div class="container">
  <div class="row">
  <div class="col-sm-8" > 
 <br>
YEAR
<input   name="year" type="number" size="15"  min="2022" max="2030"  required="on"  class="form-control input-sm"    autocomplete="off" ><br>
  </div>
    <div class="col-sm-4" >
