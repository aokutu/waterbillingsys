...
#dashboard{
  ...
  $(document).ready(function(){
   ...
   //$("#statement").load("backup/singlebill.php");
   //$("#statement").load("backup/trialbill.php");
	$("#searchaccountx").submit(function()
...
$('#message').modal('show'); $("#statement").load("backup/singlebill.php");
});  return false;
})
...
$("#pagnationx").click(function(){$('#prepostmessage').modal('show');
$.post( "nextaccount3.php",
$("#pagnation").serialize(),
function(data){
$("#content").load("message.php #content");$("#statement").load("backup/singlebill.php"); $('#prepostmessage').modal('hide');
$('#message').modal('show');$('#searchaccount').modal('show');
...
<div class="container"  style="text-align:center;">
   <form action="nextaccount3.php" method="post"  id="pagnation" >

	    <a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="SEARCH ACCOUNT" data-placement="bottom">
	    <button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#searchaccount">SELECT DATE </button>
	    </a>
  ...
  <form class="modal fade" id="searchaccount" role="dialog"    action="massprintbill.php" method="post"  >
  <div class="modal-dialog modal-lg"  >
  <div class="modal-content"><div class="modal-header"><div class="modal-header">
  <div class="container">
  <div class="row">
  <div class="col-sm-8">  <br>
  <h2 style="text-align:center;">SELECT  BILL  PRINTING MONTH </h2>
MONTH
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="SELECT BILLING DATE " data-placement="bottom">
<input   name="date" type="month" size="15" placeholder="SELECT BILLING DATE."  required="on"  class="form-control input-sm"   id="search-box"    autocomplete="off" ></a>
