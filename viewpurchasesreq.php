...
$_SESSION['purchasereqnumber']=trim(addslashes(strtoupper($_POST['serialnumber'])));
...
#dashboard{
  ...
  $(document).ready(function(){
   ...
   $("#statement").load("backup/storespurchasesrequisition.php");
...
<div class="container"  style="text-align:center;">
  ...
  <form class="modal fade" id="searchaccount" role="dialog"    action="currentbillsession.php" method="post"  >
...
DATE 
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="SELECT BILLING DATE " data-placement="bottom">
<input   name="date" type="date" size="15" placeholder="SELECT BILLING DATE."  required="on"  class="form-control input-sm"   id="search-box"    autocomplete="off" ></a>
