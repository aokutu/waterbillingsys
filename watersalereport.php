...
$("#bills").load("watersalesdistributionreport.php #billsdata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("sessionregistry.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#bills").load("watersalesdistributionreport.php #billsdata");$('#message').modal('show');
