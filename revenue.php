...
$("#revenue").load("revenuereport2.php #revenuedata");	

   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("waterflowsession.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#revenue").load("revenuereport2.php #revenuedata");$('#message').modal('show');
