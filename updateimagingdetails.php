...
$connect->query("UPDATE imagingservices  SET  DETAILS='$updateservices->service' ,PRICE='$updateservices->price',COPRATEPRICE='$updateservices->coprateprice' WHERE ID=$updateservices->id ");
