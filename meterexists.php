...
<input  style='text-transform:uppercase' name="account" type="text" size="15" placeholder="ENTER ACCOUNT NO."  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
...
<input  style='text-transform:uppercase' name="name" type="text" size="15" placeholder="ENTER ACCOUNT NAME."  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
CONTACT<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="ENTER  CONTACT" data-placement="bottom">
<input  style='text-transform:uppercase' name="contact" type="text" size="15" placeholder="ENTER CONTACT"   class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
...
<input  style='text-transform:uppercase' name="meterreading" type="text"  pattern="[0-9.]+"  title="INVALID ENTRIES" size="15" placeholder="ENTER METER READINGS"  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
...
<input  style='text-transform:uppercase' name="idnumber" type="number" size="15" placeholder="ENTER  ID NUMBER"  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
LOCATION<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="ENTER  LOCATION" data-placement="bottom">
<input  style='text-transform:uppercase' name="location" type="text" size="15" placeholder="LOCATION"  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
<div id="suggesstion-box"></div>
</div>

<button type="submit" class="btn-info btn-sm" >SUBMIT</button><button type="reset" class="btn-info btn-sm">RESET</button>   
  <a href="accessdenied4.php" target="_parent"  ><button type="button" class="btn-info btn-sm" >DASHBOARD</button> </a>  
  ...
  <input  style='text-transform:uppercase' name="meter" type="text" size="15" placeholder="ENTER METER NUMBER."  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a><br />
ACCOUNT  CATEGORY 
...
<div  class="radio"> 
   <label> 
     <input  type="radio"  id="optionsRadios1"  value="0.5"   name="size"     checked> 
  SIZE&frac12; 
   </label> 
</div  > 
<div  class="radio">
<div  class="radio"> 
 <label> 
     <input  type="radio"  id="optionsRadios1"  value="0.5"   name="size"     > 
  SIZE&frac12; 
   </label>  
   </div>
   <label> 
     <input type="radio"  id="optionsRadios1"  value="0.75"   name="size"  > 
  SIZE&frac34;
   </label> 
</div  > 
<div  class="radio"> 
   <label> 
     <input type="radio"  id="optionsRadios1"  value="1"   name="size"   > 
  SIZE1
   </label> 
</div  > 
<div  class="radio"> 
   <label> 
     <input  type="radio"  id="optionsRadios1"  value="3"   name="size"  > 
  SIZE3
   </label> 
</div  ><br />
  ...
  <div class="container"  id="content"> <?php echo "METER ". $_SESSION['meter']."EXISTS"; ?>
