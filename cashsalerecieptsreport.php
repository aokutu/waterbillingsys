...
$("#bills").load("recieptsreports.php #accbaldata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("sessionregistry.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#bills").load("recieptsreports.php #accbaldata");$('#message').modal('show');
...
<select class="form-control" name="category" required="on">
 ...
 <option value="zones">ENTIRE ZONES</option>
	...
	$x="SELECT * FROM zones  ";
		...
		{ print " <option value='".$y['zone']."'> ".$y['zone']."</option>";}}		   
