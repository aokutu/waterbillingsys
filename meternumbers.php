...
#dashboard{
  ...
  $(document).ready(function(){
   ...
   $('#acrange').modal('show');
   $("#updatemeterform").load("meterstable.php #contacttable");
...
function(data){
$("#content").load("message.php #content");$("#updatemeterform").load("meterstable.php #contacttable");$('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
$("#acrange").serialize(),
function(data){$("#content").load("message.php #content");$("#updatemeterform").load("meterstable.php #contacttable"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
$("#updatemeterform").submit(function()
{$('#prepostmessage').modal('show');
$.post( "updatemeterform.php",
$("#updatemeterform").serialize(),
function(data){$("#content").load("message.php #content");$("#updatemeterform").load("meterstable.php #contacttable");$('#prepostmessage').modal('hide'); $('#message').modal('show'); 
});  return false;
})
...
<body>
<div class="container">
  <a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="WALKING  PATIENT" data-placement="bottom"><button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#acrange">AC RANGE</button></a>
...
<form id="updatemeterform" method="post" action="updatemeterform.php">
	  ...
	  <li><a href="graphsummary.php"  target= "_blank">GRAPH SUMMARY</a></li> 
        <li><a href="accountstatus.php">ACC CURRENT STATUS </a></li><li><a href="watersalereport.php">WATER SALE REPORT </a></li> 
		 ...
		 <li><a href="ministatement.php">MINISTATEMENT</a></li> 
		   <li><a href="statements.php">FULL STATEMENT</a></li><li><a href="refunddeposit.php">REFUND DEPOSIT</a></li><li><a href="archivedstatements.php">ARCHIVED STATEMENT</a></li><li><a href="bills2report.php">BILLS DISTRIBUTION  REPORT</a></li><li><a href="revenue.php">REVENUE  DISTRIBUTION  REPORT</a></li><li><a href="balancereport.php">ACC  BAL DISTRIBUTION REPORT </a></li><li><a href="analysisreport.php">MONTHLY DATA ANALYSIS </a></li><li><a href="waterflow.php">WATER FLOW  REPORT</a></li><li><a href="masterdistribution.php">MASTER METERS REPORT</a></li><li><a href="accountstatus3.php">ACCOUNTS  DISTRIBUTION  REPORT   </a></li>
...
<br><br>
 ...
 <br><br>
  <?php 
  $x="SELECT  DATEDIFF('2020-08-03',CURRENT_DATE) AS ddays";
  $x=mysqli_query($connect,$x)or die(mysqli_error($connect));
		if(mysqli_num_rows($x)>0)
		{
		 while ($y=@mysqli_fetch_array($x))
  ...
  ?>
   ...
   <div class="btn-group"> 
      ...
      <ul class="dropdown-menu"> 
		...
		<li><a  href="meternumbers.php" target="_parent" >EDIT METER NUMBER</a></li>
...
<br>
  ...
  <div class="modal-dialog modal-lg"  >
  <div class="modal-content"><div class="modal-header"><div class="modal-header">ACCOUNTS</div></div>
<div class="container">
  <div class="row">
  <div class="col-sm-8" >
...
<br>
  <select class="form-control input-sm"   name="action" required="on" >
<option value=''>SELECT ACTION</option>
<option value='STATUS'>VIEW CURRENT STATUS</option>
