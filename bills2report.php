...
$("#bills").load("bills2report2.php #billsdata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("waterflowsession.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#bills").load("bills2report2.php #billsdata");$('#message').modal('show');
