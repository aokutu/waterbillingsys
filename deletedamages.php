...
SELECT CURRENT_DATE,CONCAT('$dbdetails->user'),CONCAT ('DELETED ',TRANSACTION,' WORTH ',AMOUNT,' FROM  THE  DAMAGES   REGISTRY  '),CURRENT_TIMESTAMP FROM damages  WHERE ID ='$id' ");

$connect->query("DELETE FROM damages  WHERE ID ='$id' ");

header("LOCATION:damagesreport3.php");
?>