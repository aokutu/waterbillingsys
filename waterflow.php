...
$("#productionmeterdetails").load("waterflowreport.php #productionmetertable"); 
...
$("#productionmeterdetails").load("waterflowreport.php #productionmetertable");$('#prepostmessage').modal('hide');$('#message').modal('show');
	})
return false;
})
