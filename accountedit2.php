...
$('[data-toggle="popover"]').popover(); 
 $("#updateaccounts").load("accounts.php #contacttable");	
 $("#updateaccountsx").load("accounts.php #contacttable");
...
$("#acrange").serialize(),
function(data){ 
$("#content").load("message.php #content"); $("#updateaccounts").load("accounts.php #contacttable");$('#prepostmessage').modal('hide'); $('#message').modal('show'); 
});  return false;
})	 
...
function(data){$("#content").load("message.php #content");$("#updateaccounts").load("accounts.php #contacttable"); $('#prepostmessage').modal('hide'); 
$('#message').modal('show');
});  return false;
})
...
<div class="container" >
    ...
    <a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="ACCOUNT  RANGE" data-placement="bottom"><button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#acrange">AC RANGE</button></a>
    <!-- Modal -->
  </div>
...
<form id="updateaccounts" method="post" action="updateaccount2.php">
