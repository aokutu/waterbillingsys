...
$("#revenue").load("activityreport.php #revenuedata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("waterflowsession.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#revenue").load("activityreport.php #revenuedata");$('#message').modal('show');
...
function(data){
$("#content").load("message.php #content");$("#revenue").load("activityreport.php #revenuedata"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
FROM <input   name="date1" type="month" size="15"   required="on"  class="form-control input-sm"    autocomplete="off" >
<br>
TO  

<input   name="date2" type="month" size="15"   required="on"  class="form-control input-sm"    autocomplete="off" ><br>
