...
$("#sendsms").load('emailapi.php #clock');
$("#pendingemail").load("pendingemail.php #sms"); 
}, 10000);
...
<div id="pendingsms">
 <table   id="sms" class=" table table-hover">
        ...
        <thead>
          <tr>
            <td  class="theader"   height="21" valign="top" >ACC	  </td>
			 ...
			 <td  class="theader" width ='40%'  width ="70%"  height="21" valign="top" >MESSAGE</td>            
	...
	$x="SELECT * FROM outbox     WHERE status ='PENDING' AND contact  REGEXP '@' ORDER  BY  date ,account,contact ASC";
		$x=mysqli_query($connect,$x)or die(mysqli_error($connect));
		if(mysqli_num_rows($x)>0)
		{
		 ...
		 while ($y=@mysqli_fetch_array($x))
		 {
		   echo"<tr class='filterdata'>
                ...
                <td class='btn-info btn-sm' width ='20%'    >PENDIG</td>
                <td class='btn-info btn-sm' width ='40%' >MESSAGE</td> 
