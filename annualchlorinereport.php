...
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#reports").load("chlorinereport.php #accbaldata");$('#message').modal('show');
...
function(data){
$("#content").load("message.php #content");$("#reports").load("chlorinereport.php #accbaldata"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
