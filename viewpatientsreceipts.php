...
$("#patientreciepts").load("viewpatientsreceipts.php #patientrecieptstable");	
return false;
});
return false;
})
...
<td  class="theader"    height="28" valign="top"  style='text-align:left;' >RECEIPT #</td>	
		    ...
		    <td  class="theader"  width="40%"  height="28" valign="top" style='text-align:left;'  >PATIENT NAME</td> 
			 ...
			 <td  class="theader"    height="28" valign="top"  style='text-align:left;' >PATIENT NUMBER</td>
			  ...
			  <td  class="theader"    height="28" valign="top"  style='text-align:right;' >PAYMODE</td>
			  <td  class="theader"    height="28" valign="top"  style='text-align:right;' >PAYREFF</td>
			   ...
			   <td  class="theader"  height="28" valign="top" style='text-align:center;'  > ACTION </td> </tr>
				...
				<?php
$x=$connect->query("SELECT receiptrecords.ID,RECEIPTNUMBER,PAYMODE,PAYMENTREFF,AMOUNT,DISCOUNT,receiptrecords.DATE,TOTALCHARGES,DATE(DATE) AS DATE,CASHIER,PATIENTNUMBER,CLIENT FROM receiptrecords,patientsrecord  WHERE receiptrecords.PATIENTNUMBER=patientsrecord.ACCOUNT  AND receiptrecords.DATE >='$daterange->startdate' AND receiptrecords.DATE <='$daterange->enddate' ");
...
print $data->RECEIPTNUMBER; ?>
	...
	<td   style='text-align:left;'  ><?php print $data->PATIENTNUMBER; ?></td>			
			   <td   style='text-align:right;'  ><?php print number_format($data->TOTALCHARGES,2); ?></td>
			   			   <td   style='text-align:right;'  ><?php print $data->PAYMODE; ?></td>
			   <td   style='text-align:right;'  ><?php print $data->PAYMENTREFF; ?></td>
			   <td   style='text-align:right;'  ><?php print $data->DATE; ?></td>
				            <td style='text-align:center;'  >
							<a   href="reprintpatientreciept.php?receiptnumber=<?php print $data->RECEIPTNUMBER; ?>"   ><i class="fas fa-print" style="font-size:160%;"></i></a>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class="deletelink" data-receiptnumber="<?php print $data->RECEIPTNUMBER; ?>" > <div class="fas fa-trash" style="font-size:160%;"> </div></a>
			 </td>
	 </tr>
<?php }	?>

				<?php
$x=$connect->query("SELECT SUM(TOTALCHARGES) AS TTL  FROM receiptrecords  WHERE receiptrecords.DATE >='$daterange->startdate' AND receiptrecords.DATE <='$daterange->enddate' ");
while ($data = $x->fetch_object())
{
	$number+=1;	?>
  <tr class='filterdata'  style='text-align:center;' >
