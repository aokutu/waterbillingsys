...
$serialnumber=$_POST['serialnumber'];$_SESSION['serialnumber']=$serialnumber;

$x="SELECT ACCOUNT,NAMES,CONTACT,DATE FROM CLIENTQUOTATIONS WHERE SERIALNUMBER='$serialnumber'  LIMIT 1  ";
...
$_SESSION['name']=$y['NAMES'];
$_SESSION['contacts']=$y['CONTACT']; 
$_SESSION['date']=$y['DATE'];
...
#dashboard{
  ...
  $(document).ready(function(){
   ...
   $("#statement").load("backup/clientquotation.php");
