...
function(data){
$("#content").load("message.php #content");$("#deletezones").load("billsrate.php #zones");$('#prepostmessage').modal('hide'); $('#message').modal('show'); 
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-8" >METER SIZE
	<input type="text" class="form-control input-sm" style="text-transform:uppercase;"  pattern="[0-9.]+" title="INVALID ENTRIES" placeholder="ENTER CUBIC UNITS  " name="class"    required="on" /><br>
	METER CHARGES 
	<input type="text"  pattern="[0-9. ]+"   title="INVALID ENTRIES"  placeholder="ENTER METER CHARGES" class="form-control input-sm"  name="acclassa"   autocomplete="off" required="on" />
...
<h4   style="text-align:center"><strong><u>BILLING CHARGE RATES </u></strong></h4>
 <table    class=" table table-hover">
        ...
        <thead>
          <tr>
		  <td  class="theader"    height="21" valign="top" >METER SIZE </td>
