...
$("#bills").load("waterdistributionreport.php #billsdata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("waterflowsession.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#bills").load("waterdistributionreport.php #billsdata");$('#message').modal('show');
...
function(data){
$("#content").load("message.php #content");$("#bills").load("waterdistributionreport.php #billsdata"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
