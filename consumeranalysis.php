...
$("#consumers").load("consumeranalysis2.php #consumerdata");
   $("#viewreports").submit(function(){$('#prepostmessage').modal('show');
$.post("consumeranalysissession.php",$("#viewreports").serialize(),function (data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#consumers").load("consumeranalysis2.php #consumersdata");$('#message').modal('show');
...
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="VIEW REPORTS" data-placement="bottom"><button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#viewreports">VIEW REPORTS</button></a>
  ...
  <form class="modal fade" id="viewreports" role="dialog"    action="consumeranalysissession.php" method="post"  >
