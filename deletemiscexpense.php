...
*/
$connect ->query("DELETE  FROM `miscexpences` WHERE paymentmode =(SELECT  PAYMENTMODE FROM  miscexpences WHERE ID =$deletemiscexpence->deleteid ) 
AND PAYMENTREFF =(SELECT  PAYMENTREFF FROM  miscexpences WHERE ID=$deletemiscexpence->deleteid );  ");
