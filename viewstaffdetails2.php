	...
	<body style="font-size:50%;" >
		<div class="invoice-box">
			<table cellpadding="0.5" cellspacing="1">
				...
				<?php
$x = $connect ->query("SELECT ID,TITLE,IDNUMBER,NAMES,KRAPIN,BASICSALARY FROM  STAFFS WHERE ID= '$id' ");
...
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >TITLE </td>
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >  <?php print $data->TITLE;?> </td>
...
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >KRA PIN </td>
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >  <?php print $data->KRAPIN;?> </td>
...
?>
				...
				<?php
$x = $connect ->query("SELECT ID,BASICSALARY,HOUSEALLOWANCE,TRAVELALLOWANCE,PAYEE,NHIF,NSSF,HARDSHIPALLOWANCE FROM  STAFFS WHERE ID= '$id' ");
while ($data = $x->fetch_object())
{
    ...
    <tr  style="font-size:75%;"  >
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >BASIC SALARY </td>
...
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >PAYEE </td>
...
<tr  style="font-size:75%;"  >
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >HOUSE ALLOWANCE </td>
...
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >NHIF </td>
...
<tr  style="font-size:75%;"  >
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >TRAVELLING ALLOWANCE </td>
...
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >NSSF </td>
...
<tr  style="font-size:75%;"  >
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >HARDSHIP ALLOWANCE ALLOWANCE </td>
...
<td  style="text-align:right;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >NET SALARY </td>
