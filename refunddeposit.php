 <?php
 header("LOCATION:accessdenied4.php");
@session_start();
@$user=$_SESSION['user'];
...
$("#accstatementreport").modal();
$("#report").load("refunddeposit2.php #reportx");
  $("#account2").click(function() {
     var account=$("#account1").val();
	 $("#account2").val(account);
	 });
$('[data-toggle="popover"]').popover(); 
$("#accstatementreport").submit(function(){$('#prepostmessage').modal('show');
$.post( "sessionregistry.php",
$("#accstatementreport").serialize(),
function(data){
	$("#report").load("refunddeposit2.php #reportx");
...
<body  style="style:margin-right:5%;margin-left:5%;">

<div class="container">
  <!-- Trigger the modal with a button -->
  <a href="#" title="ENTER" data-toggle="popover" data-trigger="hover" data-content=" ACCOUNT  RANGE" data-placement="bottom">
  <button type="button" class="btn-info btn-sm" data-toggle="modal" data-target="#accstatementreport">ACS RANGE</button>
 ...
 <form class="modal fade" id="accstatementreport" role="dialog" method="post"  action="refunddeposit2.php">
  <div class="modal-dialog modal-lg"  >
  <div class="modal-content"><div class="modal-header"><div class="modal-header" style="text-align:center;">SELECT COVERAGE </div></div>
<div class="container">
  <div class="row">
  <div class="col-sm-8" > 
