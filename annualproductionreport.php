...
$("#content").load("message.php #content");$('#prepostmessage').modal('hide');$("#reports").load("productionreport.php #accbaldata");$('#message').modal('show');
...
function(data){
$("#content").load("message.php #content");$("#reports").load("productionreport.php #accbaldata"); $('#prepostmessage').modal('hide'); $('#message').modal('show'); 
