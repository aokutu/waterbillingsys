...
//$("#pricelisttable").load("registry.php #accountstable");	
 ...
 $(document).on('click', '.deleteurinalysis', function(event) {
        ...
        var procedureid = $(this).data('procedureid');
        var msg = 'DELETE URINALYSIS RESULTS ';
        var confirmdelete = confirm(msg);
		if(confirmdelete==false){return false;}
...
$x=$connect->query("SELECT  DISTINCT TRACKKEY,PROCEDURES,ATTENDANT,DATE,PATIENTNUMBER,NAME,GENDER,AGE  FROM  procedureresults  WHERE DATE >='$daterange->startdate' AND DATE <='$daterange->enddate'  ");
...
//$x=$connect->query("SELECT  DISTINCT TRACKKEY,ATTENDANT,DATE,PATIENTNUMBER,NAME,GENDER,AGE  FROM  completebloodcountresults  WHERE DATE >='$daterange->startdate' AND DATE <='$daterange->enddate'  ");
$x=$connect->query("SELECT  completebloodcountresults.ID,TRACKKEY,PATIENTNUMBER,CLIENT,completebloodcountresults.DATE  FROM  completebloodcountresults,patientsrecord WHERE DATE >='$daterange->startdate' AND DATE <='$daterange->enddate'  AND completebloodcountresults.PATIENTNUMBER=patientsrecord.ACCOUNT ");
...
while ($data = $x->fetch_object())
{
    ...
    <tr >
		  <td    width="5%" height="28" valign="top" style='text-align:center;' ><?php print $number; ?></td> 
	<td      height="28" valign="top"  style='text-align:left;' ><?php print $data->TRACKKEY; ?> </td>	
	<td      height="28" width="40%" valign="top"  style='text-align:left;' >COMPLETE BLOOD COUNT</td>	  
<td      height="28" valign="top"  style='text-align:left;' ><?php print $data->PATIENTNUMBER; ?> </td>	
		 <td      height="28" valign="top" style='text-align:left;'  ><?php print $data->CLIENT; ?></td> 
		
			   <td      height="28" valign="top"  style='text-align:right;' ><?php print $data->DATE; ?></td>
			   <td    height="28" valign="top" style='text-align:center;'  >
			   <a   href="reprintcompletebloodcount.php?trackkey=<?php print $data->TRACKKEY; ?>"   ><i class="fas fa-print" style="font-size:160%;"></i></a>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class="deletecompletebloodcount" data-procedureid="<?php print $data->TRACKKEY; ?>" > <div class="fas fa-trash" style="font-size:160%;"> </div></a>
 </td> </tr>
...
//$x=$connect->query("SELECT  DISTINCT TRACKKEY,ATTENDANT,DATE,PATIENTNUMBER,NAME,GENDER,AGE  FROM  completebloodcountresults  WHERE DATE >='$daterange->startdate' AND DATE <='$daterange->enddate'  ");
$x=$connect->query("SELECT  urinalysis.ID,TRACKKEY,PATIENTNUMBER,CLIENT,urinalysis.DATE  FROM  urinalysis,patientsrecord WHERE DATE >='$daterange->startdate' AND DATE <='$daterange->enddate'  AND urinalysis.PATIENTNUMBER=patientsrecord.ACCOUNT ");
...
while ($data = $x->fetch_object())
{
    ...
    <tr >
		  <td    width="5%" height="28" valign="top" style='text-align:center;' ><?php print $number; ?></td> 
	<td      height="28" valign="top"  style='text-align:left;' ><?php print $data->TRACKKEY; ?> </td>	
	<td      height="28" width="40%" valign="top"  style='text-align:left;' >URINALYSIS</td>	  
<td      height="28" valign="top"  style='text-align:left;' ><?php print $data->PATIENTNUMBER; ?> </td>	
		 <td      height="28" valign="top" style='text-align:left;'  ><?php print $data->CLIENT; ?></td> 
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class="deleteurinalysis" data-procedureid="<?php print $data->TRACKKEY; ?>" > <div class="fas fa-trash" style="font-size:160%;"> </div></a>
 </td> </tr>
