...
$("#stockcard").submit(function(){
	var action='STOCK CARD REPORT';
	 var x=confirm(action);   
	 if(x ==false){return false; }
$.post( "sessionregistry.php",
$("#stockcard").serialize(),
function(data){$('#prepostmessage').modal('show');
$("#stockmovementreport").load("stockmovementreport2.php #stockmovementreport");
...
<div class="container">
  <!-- Trigger the modal with a button -->
       <a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="SEARCH PURCHASES " data-placement="bottom"><button class="btn-info btn-sm"  data-toggle="modal" data-target="#stockcard">STOCK CARD</button> </a>
...
<div id="stockmovementreport">
  ...
  <form class="modal fade" id="stockcard" role="dialog" method="post" action="stockmovementreport2.php">
  <div class="modal-dialog modal-lg"  >
  <div class="modal-content"><div class="modal-header"><div class="modal-header">ENTER ITEM DETAILS</div></div>
  <div class="container">
  <div class="row">
