...
<?php print strtoupper(str_pad($reffnumber, 10, "0", STR_PAD_LEFT)); ?>				</td>
	 ...
	 <?php print $recieptdate; ?></td></tr>
				...
				<tr class="heading" style="font-weight: bold;text-align:center;" >
				    <td  style='border: 1px solid black; border-collapse: collapse;text-align:center;'>CODE</td>
					<td  style='border: 1px solid black; border-collapse: collapse;text-align:center;'>Item</td>

					<td  style='border: 1px solid black; border-collapse: collapse;text-align:center;'>Charges</td>
				</tr>
						
				<?php
				
					$id=$_SESSION['id'];							
		$x="SELECT $nonwaterbills.NAME,$nonwaterbills.AMOUNT,CODE FROM $nonwaterbills,paymentcode WHERE  $nonwaterbills.ID =$id AND $nonwaterbills.NAME=paymentcode.NAME  ";
		$x=mysqli_query($connect,$x)or die(mysqli_error($connect));
		if(mysqli_num_rows($x)>0)
		{
		...
		print "<tr class='item' style='text-align:center;'>";
			print "<td  style='border: 1px solid black; border-collapse: collapse;'>".$y['CODE']."</td>";
		print "<td  style='border: 1px solid black; border-collapse: collapse;text-align:center;'>".$y['NAME']."</td>";	
