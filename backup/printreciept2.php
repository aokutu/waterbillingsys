...
<?php print strtoupper(str_pad($recieptnumber, 10, "0", STR_PAD_LEFT)); ?>				</td>
 <td  style="text-align:center;font-weight:bold;border: 1px solid black; border-collapse: collapse;" >PAYMENT DATE <br>
	 <?php 
	$x="SELECT $wateraccountstable.DEPOSITDATE  FROM $wateraccountstable WHERE  $wateraccountstable.RECIEPTNUMBER='$recieptnumber' LIMIT 1 ";
		$x=mysqli_query($connect,$x)or die(mysqli_error($connect));
		if(mysqli_num_rows($x)>0)
		{
...
$x=mysqli_query($connect,$x)or die(mysqli_error($connect));
	 ...
	 ?></td></tr>
				...
				<tr   >
							...
							<tr >
								<td style="font-weight:bold;border: 1px solid black; border-collapse: collapse;text-align:left;">
									ACCOUNT NUMBER
								</td>
								
									<td  style="text-align:left;text-decoration:underline;text-decoration-style: dotted;border: 1px solid black; border-collapse: collapse;" >
				...
				<tr class="heading" style="font-weight: bold;text-align:center;" >
					...
					<td  style='border: 1px solid black; border-collapse: collapse;text-align:left;'>AMOUNT</td>
				</tr>
		...
		if(mysqli_num_rows($x)>0)
		{
		 ...
		 while ($y=@mysqli_fetch_array($x))
		{
		print "<tr class='item' style='text-align:left;'>";	
		print "<td  style='border: 1px solid black; border-collapse: collapse;'>".$y['NAME']."</td>";	
		print "<td  style='border: 1px solid black; border-collapse: collapse;text-align:left;' >".number_format($y['CREDIT'],2)."</td>";	
		print "</tr>";	
		}}
		...
		print "<td  style='border: 1px solid black; border-collapse: collapse;text-align:left;font-weight: bold;' >".number_format($y['SUM(CREDIT)'],2)."</td>";	
		print "</tr>";	
		}}
	...
	<td style='border: 1px solid black; border-collapse: collapse;font-weight: bold;text-align:left;' >TOTAL IN WORDS</td>
	<td style='border: 1px solid black; border-collapse: collapse;font-weight: bold;text-align:left;' >
<?php
...
<table>
<tr>
					<td  style='border: 1px solid black; border-collapse: collapse;text-align:center;font-weight: bold;'><br>ATTENDANT</td>

					<td  style='border: 1px solid black; border-collapse: collapse;text-align:center;font-weight: bold;'><br><?php print $user; ?></td>
					<td  style='border: 1px solid black; border-collapse: collapse;text-align:left;font-weight: bold;'><br>SIGN:......................</td>
					<td  style='border: 1px solid black; border-collapse: collapse;text-align:center;font-weight: bold;'><br>RUBBER STAMP</td>
					</tr>
					<table>
				</tr>	
