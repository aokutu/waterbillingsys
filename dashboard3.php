 ...
 <div class="container">
  ...
  <div class="btn-group"> 
      <button type="button" class="btn btn-default dropdown-toggle" 
       ...
       <a href="#"  title="REPORTS" data-toggle="popover" data-trigger="hover" data-content="MODULE" data-placement="bottom" >ACCOUNTS&nbsp;&nbsp;&nbsp;&nbsp;
	   <img src ="ICON17.png"  width="20%"  height="20%"> </a>
        <span class="caret"></span> 
      </button> 
      <ul class="dropdown-menu" id="longmenu"> 
	  <li><a href="balancesheet.php"  >BALANCE SHEET </a></li> 
    <li><a href="balancesheet.php" >INCOME STATEMENT  </a></li> 
    <li><a href="balancesheet.php" >CASH FLOW  </a></li> 
 ...
 <div class="btn-group"> 
  ...
  <div class="btn-group"> 
      <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"> 
       ...
       PAY ROLL &nbsp;&nbsp;&nbsp;<img src ="ICON23.png"  width="20%"  height="20%">
	   </a>
        <span class="caret"></span> 
		
      </button> 
      <ul class="dropdown-menu"> 
        <li><a   href="staffsregistry.php" target= "_parent" >STAFFS REGISTRY  </a></li>
        <li><a   href="staffpayroll.php" target= "_parent" >STAFFS PAY ROLL   </a></li>  
