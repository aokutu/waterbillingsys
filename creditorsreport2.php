...
<h3 style="text-align:center"><strong>CREDIT REPORT FROM  <?php print $account1 ;?> TO <?php print $account2;?></strong>
<a href="creditorsreportpdf.php"><i class="fas fa-file-pdf"></i> </a>
<a href="creditorsreportoexcel.php"><i class="fas fa-file-excel"></i> </a>
</h3>
		   ...
		   echo "<tr   class='filterdata'  >
                <td   >".$y['account']."</td>
				 <td  width='20%' >".$y['client']."</td>
				   <td  >&nbsp;&nbsp;&nbsp;".number_format(abs($y['totalbill']),2)."</td>
		   ...
		   echo "<tr  class='btn-info btn-sm'   >
                <td  >TOTAL</td>
				 ...
				 <td  width='20%' > </td>
				   ...
				   <td  >".number_format(abs($y['SUM(TOTALBILL)']),2)."</td>
