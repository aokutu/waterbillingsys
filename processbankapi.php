...
$("#sendsms").load('bankapi.php #clock');
$("#pendingsms").load("processbankapi.php #sms"); 
}, 10000);
...
<h4   style="text-align:center"><strong>PENDING TRANSACTIONS </strong></h4>
<div id="pendingsms">
 <table   id="sms" class=" table table-hover">
        ...
        <thead>
          <tr>
            <td  class="theader"   width ='30%'  height="21" valign="top" >ACC	  </td>
			 <td  class="theader"     height="21" valign="top" >TRANSACTION</td> 
			 <td  class="theader"    height="21" valign="top" >DEPOSITDATE</td>   
				<td  class="theader"    height="21" valign="top" >PROCESSING DATE</td> 
<td  class="theader"    height="21" valign="top" >PROCESSING ID</td> 				
	...
	//$x="SELECT * FROM WATERACCOUNTS  WHERE STATUS =''";
	$x="SELECT * FROM WATERACCOUNTS WHERE STATUS NOT REGEXP 'PROCESSED'";
...
$x="SELECT COUNT(ID),SUM(CREDIT) FROM WATERACCOUNTS WHERE STATUS  NOT REGEXP 'PROCESSED' ";
		$x=mysqli_query($connect2,$x)or die(mysqli_error($connect2));
		if(mysqli_num_rows($x)>0)
		{
		 ...
		 {
		   echo"<tr class='filterdata'>
                <td    width ='30%'  >TOTAL TRANSACTIONS  " .$y['COUNT(ID)']."</td>
                <td     ></td> <td     ></td><td     ></td>
                <td  >TOTAL</td> 
				 <td  >".$y['SUM(CREDIT)']."</td>
				<td  ><img src ='LoaderIcon.gif'></td>
