...
$('#searchaccount').modal('show');
   $("#updateaccount").load("transferform.php #accountdetails");
$("#searchaccount").submit(function()
{$('#prepostmessage').modal('show');
$.post( "transferaccnumber.php",
...
$('#message').modal('show'); 
 $("#updateaccount").load("transferform.php #accountdetails");
   ...
   $("#account2").click(function() {
     var account=$("#search-box").val();
	 var newaccount=parseInt(account)+1;
		$("#account2").val(newaccount);
	 });
$("#updateaccount").submit(function()
{$('#prepostmessage').modal('show');
$.post( "accounttransfer3.php",
$("#updateaccount").serialize(),
function(data){$("#content").load("message.php #content"); $('#prepostmessage').modal('hide');
$('#message').modal('show');  $("#updateaccount").load("transferform.php #accountdetails");
});  return false;
});
 })
...
<div class="container">
  <!-- Trigger the modal with a button -->
   ...
   <!-- Modal -->
    ...
    <form class="modal fade" id="searchaccount" role="dialog"    action="transferaccnumber.php" method="post"  >
  ...
  <div class="frmSearch">
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="ENTER  ACCOUNT" data-placement="bottom"><input  style='text-transform:uppercase'   name="account" type="text" size="15" placeholder="ENTER CURRENT ACCOUNT NO."  required="on"  class="form-control input-sm"   id="search-box"  pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a>
<div id="suggesstion-box"></div>
</div>
<hr>
<a href="#" title="INFO" data-toggle="popover" data-trigger="hover" data-content="NEW  ACCOUNT" data-placement="bottom"><input  style='text-transform:uppercase' id="account2"   name="account2" type="text" size="15" placeholder="ENTER NEW ACCOUNT NO."  required="on"  class="form-control input-sm"   pattern="[0-9A-Za-z]{11}"  title="INVALID ENTRIES"  autocomplete="off" ></a>
<hr>
...
<form id="updateaccount"  method="post"   action="accounttransfer3.php"> 
