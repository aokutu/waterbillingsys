...
$("#editdebts").submit(function(){$('#prepostmessage').modal('show');
$.post( "editdebts.php",
$("#editdebts").serialize(),
function(data){
$("#content").load("message.php #content");$('#prepostmessage').modal('hide'); $('#message').modal('show'); 
$("#editdebts").load("debtregistry.php #zones"); 
return false;});
...
<div id="debtstatement">
<h4   style="text-align:center"><strong>DEBT STATEMENT FOR ACCOUNT <?php print $account ;?>  </strong></h4>
 ...
 <option value='DELETE2'>DELETE DEBT</option> 			  
			  </select>	  </td>
         </tr>
        </thead>
        <tbody>
...
$x="SELECT *,(@TTL := amount + @TTL) AS TTLSUM FROM DEBTPAY ORDER BY ID DESC   ";
		$x=mysqli_query($connect,$x)or die(mysqli_error($connect));
		if(mysqli_num_rows($x)>0)
		{
  ...
  <div class="btn-group"> 
   <div class="btn-group"> 
      ...
      <ul class="dropdown-menu"> 
        <li><a   href="users.php" target= "_parent" >USER ADMIN </a></li><li><a   href="companyadmin.php" target= "_parent" >COMPANY ADMIN </a></li><li><a   href="debtregistry.php" target= "_parent" >ZONE ADMIN </a></li>  
