...
autocomplete(document.getElementById("myInput"), countries);
   ...
   <div>
            ...
            <input type="text" id="account" class="form-control input-sm"  placeholder="ENTER ACC NUMBER"  style="text-transform:uppercase"   />
	...
	<input type="text" id="meter" class="form-control input-sm"  placeholder="ENTER METER NUMBER"  style="text-transform:uppercase"   />
